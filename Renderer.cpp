...
bool Renderer::keys[1024], render;
...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	static auto bone_1_x_widget = gui_1->addVariable("Rotation X1", m_bone_animation->bone_1_rotation[0]);
	static auto bone_1_y_widget = gui_1->addVariable("Rotation Y1", m_bone_animation->bone_1_rotation[1]);
	static auto bone_1_z_widget = gui_1->addVariable("Rotation Z1", m_bone_animation->bone_1_rotation[2]);

	static auto bone_2_x_widget = gui_1->addVariable("Rotation X2", m_bone_animation->bone_2_rotation[0]);
	static auto bone_2_y_widget = gui_1->addVariable("Rotation Y2", m_bone_animation->bone_2_rotation[1]);
	static auto bone_2_z_widget = gui_1->addVariable("Rotation Z2", m_bone_animation->bone_2_rotation[2]);

	static auto bone_3_x_widget = gui_1->addVariable("Rotation X3", m_bone_animation->bone_3_rotation[0]);
	static auto bone_3_y_widget = gui_1->addVariable("Rotation Y3", m_bone_animation->bone_3_rotation[1]);
	static auto bone_3_z_widget = gui_1->addVariable("Rotation Z3", m_bone_animation->bone_3_rotation[2]);

	gui_1->addButton("Rotate bones", []() {
		render = true;
	});
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	{
		m_bone_animation->reset();
		m_bone_animation->bone_3_rotate();
		m_bone_animation->bone_2_rotate();
		m_bone_animation->bone_1_rotate();

		render = false;
	}

	glm::mat4 root_bone_obj_mat = m_bone_animation->get_root_bone_mat();
	glm::mat4 bone_1_obj_mat = m_bone_animation->get_bone_1_mat();
	glm::mat4 bone_2_obj_mat = m_bone_animation->get_bone_2_mat();
	glm::mat4 bone_3_obj_mat = m_bone_animation->get_bone_3_mat();
